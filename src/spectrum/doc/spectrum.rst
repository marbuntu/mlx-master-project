...
(NTN), i.e. communcation scenarios where the propagation of the signal travels through the atmosphere.
...
Four propagation scenarios are identified, in decreasing order of building hieght and density: Dense Urban, Urban, 
Suburban and Rural. Channel estimation paramters are scenario-dependent.
